...
contract PriceFeed {
     ...
     */
    function transmit(uint256 issueId, string memory val) public returns (bytes32) {
    ...
    function latestAnswerIssueId(uint256 issueId) public returns (uint128) {
        ...
        SedaDataTypes.DataResult memory dataResult = sedaProverContract.getDataResult(tempDataRequestId);
